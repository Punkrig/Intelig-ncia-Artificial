...
Overfitting (Sobreajuste): O modelo aprende demais, incluindo ruídos dos dados de treino, e vai mal nos dados novos.

Underfitting (Subajuste): O modelo é simples demais e não consegue capturar os padrões dos dados nem mesmo no treino.
